...
![action](https://img.shields.io/github/actions/workflow/status/hishprorg/nisi-voluptatem-consequuntur/cd.yml)![npm](https://img.shields.io/npm/dw/@hishprorg/nisi-voluptatem-consequuntur)[![Coverage Status](https://coveralls.io/repos/github/hishprorg/nisi-voluptatem-consequuntur/badge.svg?branch=master)](https://coveralls.io/github/hishprorg/nisi-voluptatem-consequuntur?branch=master)![release](https://img.shields.io/librariesio/release/npm/@hishprorg/nisi-voluptatem-consequuntur)![npm](https://img.shields.io/npm/v/@hishprorg/nisi-voluptatem-consequuntur)![sourcerank](https://img.shields.io/librariesio/sourcerank/npm/@hishprorg/nisi-voluptatem-consequuntur)![NPM](https://img.shields.io/npm/l/@hishprorg/nisi-voluptatem-consequuntur)[![Code Climate](https://codeclimate.com/github/hishprorg/nisi-voluptatem-consequuntur/badges/gpa.svg)](https://codeclimate.com/github/hishprorg/nisi-voluptatem-consequuntur)[![Test Coverage](https://codeclimate.com/github/hishprorg/nisi-voluptatem-consequuntur/badges/coverage.svg)](https://codeclimate.com/github/hishprorg/nisi-voluptatem-consequuntur/coverage)[![codecov](https://codecov.io/gh/hishprorg/nisi-voluptatem-consequuntur/graph/badge.svg?token=0VLDX7ON0N)](https://codecov.io/gh/hishprorg/nisi-voluptatem-consequuntur)[![docs](https://img.shields.io/badge/docs-info-blue)](https://linyisonger.github.io/3r.Tool/)

#### 如何使用工具包 ?

👇Vue 小栗子 🐿

1.在工程下执行命令`npm i @hishprorg/nisi-voluptatem-consequuntur`安装依赖包

2.引用对应的工具类`import { Maths } from "@hishprorg/nisi-voluptatem-consequuntur";`
...
<script>
import { Maths } from "@hishprorg/nisi-voluptatem-consequuntur";
export default {
  data() {
    return {
      sum: 0,
...
2.引用对应的工具类`import { Maths } from "https://gcore.jsdelivr.net/npm/@hishprorg/nisi-voluptatem-consequuntur@0.0.14/index.js"`注意版本
...
<html lang="en">
  ...
  <body>
    <script type="module">
      import { Maths } from "https://gcore.jsdelivr.net/npm/@hishprorg/nisi-voluptatem-consequuntur@0.0.14/index.js";
...
https://github.com/hishprorg/nisi-voluptatem-consequuntur/issues/new
